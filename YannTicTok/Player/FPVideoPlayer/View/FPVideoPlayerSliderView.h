...
@protocol FPVideoPlayerSliderViewDelegate <NSObject>
...
@interface FPVideoPlayerSliderViewButton : UIButton

@end


@interface FPVideoPlayerSliderView : UIView

@property (nonatomic, weak) id<FPVideoPlayerSliderViewDelegate> delegate;

/** 滑块 */
@property (nonatomic, strong, readonly) FPVideoPlayerSliderViewButton *sliderBtn;
