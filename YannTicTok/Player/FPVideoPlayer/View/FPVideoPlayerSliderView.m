//
//  FPVideoPlayerSliderView.m
//  Funnyplanet
//
//  Created by YannChee on 2021/11/1.
//

#import "FPVideoPlayerSliderView.h"
#import "YYKit.h"
...
@implementation FPVideoPlayerSliderViewButton
...
@interface FPVideoPlayerSliderView ()
...
/** 滑块 */
@property (nonatomic, strong) FPVideoPlayerSliderViewButton *sliderBtn;
...
@implementation FPVideoPlayerSliderView
...
- (FPVideoPlayerSliderViewButton *)sliderBtn {
    if (!_sliderBtn) {
        _sliderBtn = [FPVideoPlayerSliderViewButton buttonWithType:UIButtonTypeCustom];
